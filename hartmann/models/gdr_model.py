...
class GradientRetrievalEnhancedMBO(nn.Module):
    ...
    def __init__(self,
        ...
        super(GradientRetrievalEnhancedMBO, self).__init__()
    ...
    def optimize(self, x, steps, pool):
        ...
        def gradient_step(xt):
            ...
            tmp_retrieval_set = self.search_engine(xt, pool)
